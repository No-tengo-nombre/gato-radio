...
class radio_transmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "radio_transmitter")
        ...
        self._ganancia_win = GrRangeWidget(self._ganancia_range, self.set_ganancia, "ganancia", "counter_slider", float, QtCore.Qt.Horizontal, "value")
        ...
        self.osmosdr_sink_0.set_center_freq(93.1e6, 0)
        self.osmosdr_sink_0.set_freq_corr(0, 0)
        self.osmosdr_sink_0.set_gain(10, 0)
        self.osmosdr_sink_0.set_if_gain(20, 0)
        self.osmosdr_sink_0.set_bb_gain(20, 0)
        self.osmosdr_sink_0.set_antenna('', 0)
        self.osmosdr_sink_0.set_bandwidth(2e5, 0)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\Bruno\\Downloads\\Eres-Tan-Fea...Pero-Te-Quiero.wav', True)
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_cc(ganancia)
    ...
    def set_ganancia(self, ganancia):
        ...
        self.blocks_multiply_const_vxx_1.set_k(self.ganancia)




def main(top_block_cls=radio_transmitter, options=None):
