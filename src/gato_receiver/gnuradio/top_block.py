...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.center_freq = center_freq = 93300000
        self.audio_gain = audio_gain = 1

        ##################################################
        # Blocks
        ##################################################
        self._channel_freq_range = Range(50000000, 150000000, 1, 93300000, 200)
        ...
        self._audio_gain_range = Range(0, 100, 1e-6, 1, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, (center_freq - channel_freq), 1, 0, 0)
