...
class gato_receiver_tcp(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "gato_receiver_tcp")
        ...
        self.network_tcp_sink_0 = network.tcp_sink(gr.sizeof_float, 1, '127.0.0.1', tcp_port,2)
...
def main(top_block_cls=gato_receiver_tcp, options=None):
